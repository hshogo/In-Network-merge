...
$points[0]=array("id"=>"http://jo2lxq.hongo.wide.ad.jp/experiment4/Temperature",
				  "value" => $values);

$values= array();
$values[0]=array("time"=>$past0, "_" => strval(mt_rand(500,599)));
$points[1]=array("id"=>"http://jo2lxq.hongo.wide.ad.jp/experiment4/CO2",
				  "value" => $values);
  
$values= array();
$values[0]=array("time"=>$past0, "_" => strval(mt_rand(5000,7000)*1.0+mt_rand(0,9)/10.0));
$points[2]=array("id"=>"http://jo2lxq.hongo.wide.ad.jp/experiment4/Power",
				  "value" => $values);

// Summarize into PointSet
$pointSet=array("id"=>"http://jo2lxq.hongo.wide.ad.jp/experiment4/",
				"point" => $points);
